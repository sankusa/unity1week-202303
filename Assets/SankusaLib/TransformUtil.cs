...
namespace SankusaLib
{
    public static class TransformUtil
    {
        ...
        public static List<T> AdjustChildCount<T>(DiContainer container, Transform parent, GameObject prefab, int count) where T : MonoBehaviour
        {
            AdjustChildCount(container, parent, prefab, count);
        ...
        public static void AdjustChildCount(DiContainer container, Transform parent, GameObject prefab, int count)
        {
            int childCount = parent.childCount;
            int countDiff = count - childCount;
            if(countDiff > 0)
